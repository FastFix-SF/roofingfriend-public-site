        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <div className="md:col-span-3 relative rounded-lg overflow-hidden h-[320px] sm:h-[400px] md:h-[500px]">
            ...
            <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6">
              ...
              <p className="text-xs sm:text-sm text-white/80 mt-1">50+ year lifespan. Class A fire-rated. Hail, wind & wildfire ready.</p>
              <div className="flex gap-2 sm:gap-3 mt-4 flex-wrap">
                <button onClick={openBooking} className="px-4 sm:px-6 py-2.5 rounded text-xs sm:text-sm font-medium bg-cta-blue text-white hover:opacity-90 transition-opacity">Get a Free Roof Assessment</button>
                <a href="/commercial-roofing" className="px-4 sm:px-6 py-2.5 rounded text-xs sm:text-sm font-medium bg-white text-foreground hover:bg-white/90 transition-colors">Why Metal?</a>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-2 relative rounded-lg overflow-hidden h-[320px] sm:h-[400px] md:h-[500px]">
            ...
            <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6">
              ...
              <p className="text-xs sm:text-sm text-white/80 mt-1">Discipline, integrity, and craftsmanship on every roof we install.</p>
              <a href="/about" className="mt-4 inline-block px-6 sm:px-8 py-2.5 rounded text-xs sm:text-sm font-medium bg-cta-blue text-white hover:opacity-90 transition-opacity">Our Story</a>
            </div>
          </div>
        </div>
      </div>
