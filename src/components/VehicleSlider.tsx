...
const vehicles = [
  { image: slideStandingSeam, webp: slideStandingSeamWebp, category: "", title: "Standing Seam", alt: "Standing seam metal roof panels on a Bay Area home", subtitle: "Premium Metal Roof · 50+ Year Lifespan", primaryCta: "Get a Standing Seam Quote", secondaryCta: "View Projects", learnMoreLink: "/commercial-roofing" },
  { image: slideRPanel, webp: slideRPanelWebp, category: "", title: "R-Panel System", alt: "R-Panel metal roofing installed on a barn-style structure", subtitle: "Affordable Metal Strength for Homes & Barns", primaryCta: "Get an R-Panel Quote", secondaryCta: "View Projects", learnMoreLink: "/commercial-roofing" },
  { image: slideMultiV, webp: slideMultiVWebp, category: "", title: "Multi-V Panel", alt: "Multi-V architectural metal roof panels on a luxury home", subtitle: "Architectural Style for Luxury Homes", primaryCta: "Get a Multi-V Quote", secondaryCta: "View Projects", learnMoreLink: "/commercial-roofing" },
  { image: slideTpo, webp: slideTpoWebp, category: "", title: "TPO Commercial", alt: "White TPO flat roof membrane on a commercial building", subtitle: "Energy-Efficient Flat Roofs for Business", primaryCta: "Get a TPO Roof Quote", secondaryCta: "View Projects", learnMoreLink: "/commercial-roofing" },
];
            ...
            {vehicles.map((v, idx) => (
              <div key={v.title} className="min-w-0 shrink-0 grow-0 basis-[98%] sm:basis-[70%] lg:basis-[65%] pl-4">
                <div className="relative rounded-lg overflow-hidden aspect-[4/5] lg:aspect-[16/9]">
                  <SmartImage src={v.image} webpSrc={v.webp} alt={v.alt} priority={idx === 0} width={960} height={640} className="absolute inset-0 w-full h-full object-cover" />
